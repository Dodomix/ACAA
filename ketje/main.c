/* This is a main function that is used for ASCON algorithm testing
 *
 * Encryption input: 
 * - Plaintext P
 * - Associated data AD
 * - Secret key K (len(K) <= 128b)
 * - Nonce N (public message number) (len(N) <= 128b)
...
//----------VARIABLE DECLARATIONS---------------------------
    ...
    long long int ciphertext_tag_size;
    int status;
//----------------------------------------------------------
