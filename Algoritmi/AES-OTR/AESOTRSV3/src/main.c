/* This is a main function that is used for AES-OTR algorithm testing
 *
 * Encryption input: 
 * - Plaintext P
 * - Associated data AD
 ...
 * - Plaintext P
 *-------------------------------------------------------------------
 * • Primary recommended parameter set aes128otrsv1 : 16-byte key for AES-128, 12-byte nonce,
 *   16-byte tag, and serial ADP.
 * • Fourth recommended parameter set aes256otrsv1 : 32-byte key for AES-256, 12-byte nonce,
 *   16-byte tag, and serial ADP.
 */
