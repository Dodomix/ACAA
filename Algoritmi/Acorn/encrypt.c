...
int main()
{
    ...
    unsigned long long  msglen, adlen, clen;
    ...
    for( i = 0; i < msglen; i++) printf("%3x", plaintext[i]);


    printf("\n\n%d", t);

    printf("\n\nThe tag is: ");
    for( i = 0; i < 16; i++) printf("%2x", ciphertext[msglen+i]); // tag = MAC, 16B nakon sifrirane poruke ciphertexta
}
